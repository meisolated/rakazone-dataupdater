 ...
 * @returns Url of api
 */
export const youtube_channel_live_stream_viewers_count = (video_id: string, api_key: string) =>
 ...
 * @returns Url of api
 */
export const instagram_user_data = (username: string) => `https://www.instagram.com/${username}/?__a=1`
